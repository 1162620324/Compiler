...
public class SomeWord {
	...
	public static String DIGIT = "0123456789"; //十进制
	
	public static String DIGIT_P = "123456789"; //十进制，第一位
	
	public static String DIGIT_O = "01234567"; //八进制
	
	public static String DIGIT_H = "0123456789ABCDEF"; //十六进制
	
	public static String DELIMITER = "()[]{};\"\',:";
	
	public static String OP = "+-*/%&|=><!^";
	
	public static String IDENTIFIER_DFA = "<0,LETTER_,1> <1,LETTER_,1> <1,DIGIT,1>"; //标识符 的DFA
	
	public static String DELIMITER_DFA = "<0,DELIMITER,2>"; //界符的DFA
	
	public static String NOTES_1_DFA = "<0,'/',3> <3,'*',4> <4,other,4> <4,'*',5>"+  
								" <5,other,4> <5,'/',6>"; //注释/**/ 的DFA
	public static String NOTES_2_DFA = "<0,'/',3> <3,'/',7>"; //注释// 的DFA
	
	public static String NUM_DECIMAL = "<0,DIGIT_P,9> <9,DIGIT,9> <9,'.',10> <10,DIGIT,11> <11,DIGIT,11>"
										+" <9,'E',12> <12,DIGIT,14> <14,DIGIT,14> <12,'+/-',13>"
											+" <13,DIGIT,14>"; //十进制数 的DFA
	
	public static String NUM_OCTONARY = "<0,'0',15> <15,DIGIT_O,16> <16,DIGIT_O,16>"; //八进制数 的DFA
	
	public static String NUM_HEXADECIMAL = "<0,'0',15> <15,'x',17> <17,DIGIT_H,18> <18,DIGIT_H,18>"; //十六进制数 的DFA
	
	public static String OP_DFA = "<0,OP,20> <20,OP,21>"; //运算符的 DFA
	
	public static String EMPTY = "empty"; //空串
